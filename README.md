...
Phase-by-phase task breakdowns, weekly playtest notes, and the full development
history live in [`docs/ROADMAP.md`](docs/ROADMAP.md). The roadmap is moved out of
the README so this file stays about the *game* — what it is and how to play it —
rather than how it got built.
